...
iptables -t nat -A PREROUTING -i venet0 -p tcp --match multiport --dports 80,443,10001,18081 -j DNAT --to-destination 10.0.0.2
iptables -t nat -A PREROUTING -i venet0 -p udp --match multiport --dports 80,443,10001,18081 -j DNAT --to-destination 10.0.0.2
